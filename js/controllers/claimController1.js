$(function () {
    ...
    */
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (response_data.success) {
                        ...
                        // alert('jin')
                        sendmail(response_data.email, response_data.caseNumber)
    ...
    function sendmail(email,caseno){
        alert(email)
        $.ajax({
            async: true,
            crossDomain: true,
            ...
            data: JSON.stringify({
              "email":email ,
              "name": " ",
              "subject": `${caseno} Created`,
              "body": `Thank you for creating a claim..your claim with claim no : ${caseno}  has been  Created..we will get back to you soon`
            }),
            // dataType: "JSON",
            contentType: "application/json",
            processData: false,
